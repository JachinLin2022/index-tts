...
class GPT2TTSModel(nn.Module, SupportsPP, SupportsMultiModal):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.lm_head = ParallelLMHead(self.config.vocab_size,
                                      ...
                                      bias=True)
        # self.lm_head = nn.Sequential(nn.LayerNorm(self.config.n_embd), ParallelLMHead(self.config.vocab_size,
        #                               self.config.n_embd,
        #                               quant_config=quant_config,
        #                               prefix=f"{prefix}.lm_head",
        #                               bias=True))
    ...
    def forward(
        ...
        **kwargs,
        ...
        if audio_embeds is not None:
            ...
            audio_embeds = audio_embeds.to(dtype=self.embeddings.weight.dtype)
